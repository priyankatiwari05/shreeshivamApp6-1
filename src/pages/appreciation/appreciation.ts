...
export class AppreciationPage {
  ...
  fetchappreciation(){
    ...
    this.authService.postData(data, "appreciation").then(
      result => {
  ...
  submitdata()
  {
    ...
    if(this.appreciation_for=='' || this.appreciation_for==null ||this.appreciation_type=='' || this.appreciation_type==null)
    {
      ...
      const alert = this.alertCtrl.create({
        title: "Error",
        subTitle: 'Please select employee and select option write appreciation or upload pic.',
        buttons: ["OK"]
      });
      alert.present();
    }
    else if(this.appreciation_type=='write' && (this.appreciation_content=='' || this.appreciation_content==null))
    {
      ...
      const alert = this.alertCtrl.create({
        title: "Error",
        subTitle: 'Please type your appreciation content in given textarea',
        buttons: ["OK"]
      });
      alert.present();
    }
