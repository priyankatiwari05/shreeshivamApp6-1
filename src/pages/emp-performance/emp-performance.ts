...
/**
 * Generated class for the EmpPerformancePage page.
 *
...
@Component({
  selector: "page-emp-performance",
  templateUrl: "emp-performance.html"
})
export class EmpPerformancePage {
  emp_id:any;
  department:any;
  sal121: any;
  i2: any;
  ...
  ionViewDidLoad() {    
    console.log("ionViewDidLoad EmpPerformancePage");
  ...
  async show_graph()
  {
    ...
    {
      this.navCtrl.push(EmpPerformancePage,{page:'showgraph',start_date:this.start_date,end_date:this.end_date,emp_id:this.emp_id});
      // await this.fetch_performance();
    }
    else
    {
      const alert = this.alertCtrl.create({
        title: "Error",
        subTitle: 'Please select employee , from date and to date',
        buttons: ["OK"]
      });
      alert.present();
    }
  ...
  check_date()
  {
    if(this.start_date!=null && this.start_date!='')
    {
      if(this.end_date<this.start_date)
      {
        ...
        const alert = this.alertCtrl.create({
          title: "Error",
          subTitle: 'To date cannot be less that from date',
          buttons: ["OK"]
        });
        alert.present();
      }
